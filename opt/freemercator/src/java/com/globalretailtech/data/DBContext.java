...
public class DBContext {
	...
	public void init(Properties p) {
		...
		connect = p.getProperty("ConnectPrefix") +
		        p.getProperty("ConnectHost") +
		        p.getProperty("ConnectFile");
	...
	public boolean makeConnection(String d, String c, String u, String p) {
        ...
        logger.info("Connect : " + driver + " : " + connect + " : " +
                user + " : " + password);
        try {
    ...
    private Vector fetchGeneric(DBRecord rec, String fs,
    ...
    private ResultSet executeGeneric(SQLCall sql, boolean withResult)
            throws UnknownSQLCall, SQLException {
        return executeGeneric(dbctxt.generateCall(sql), withResult);
    }

    private ResultSet executeGeneric(String sql, boolean withResult)
            throws SQLException {
        logger.debug(sql);
...
//                }
    ...
    public ResultSet executeWithResult(SQLCall sql)
    ...
    public static String getClassNameForType(int type){
        ...
        else if (type == Types.BIT) return "java.lang.Boolean";//not sure on this one...
        else if (type == Types.BOOLEAN) return "java.lang.Boolean";
        else if (type == Types.CHAR) return "java.lang.Char";
        else if (type == Types.DATE) return "java.sql.Timestamp";
        else if (type == Types.TIMESTAMP) return "java.sql.Timestamp";
        else if (type == Types.DOUBLE) return "java.lang.Double";
        else if (type == Types.FLOAT) return "java.lang.Float";
        else if (type == Types.NUMERIC) return "java.lang.Float";
        else if (type == Types.INTEGER) return "java.lang.Integer";
        else if (type == Types.LONGVARCHAR) return "java.lang.String";
        else if (type == Types.REAL) return "java.lang.Float";
        else if (type == Types.SMALLINT) return "java.lang.Integer";
        else if (type == Types.TIME) return "java.sql.Timestamp";
        else if (type == Types.VARCHAR) return "java.lang.String";
        else {
