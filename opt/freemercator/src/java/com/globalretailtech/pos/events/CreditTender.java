 ...
 * @see FirstItem
 */
public class CreditTender extends PosEvent {
    ...
    public CreditTender(PosContext context) {
        initTransition();
        setContext(context);
    }
    ...
    public void engage(int value) {
        ...
        context().eventStack().loadDialog("CreditTender", context());
    ...
    private static String eventname = "CreditTender";
