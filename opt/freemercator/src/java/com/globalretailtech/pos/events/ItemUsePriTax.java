...
public class ItemUsePriTax extends PosEvent {
    ...
    public void engage(int value) {
        ...
        for (int ejIndex = context().lastItemIndex();
            ...
            if (line.lineType() == EjLine.TAX) {
                ...
                itemTax.setActiveTaxRate(EjTax.PRIMARY_TAX);
            }
        }
    ...
    private static String eventname = "ItemUsePriTax";
