 ...
 * @see
 */
public class POSKeyboardException extends JposException {

    public POSKeyboardException(int errorCode) {
        super(errorCode);
    }

    public POSKeyboardException(int errorCode, int errorCodeExtended) {
        super(errorCode, errorCodeExtended);
    }

    public POSKeyboardException(int errorCode, String description) {
