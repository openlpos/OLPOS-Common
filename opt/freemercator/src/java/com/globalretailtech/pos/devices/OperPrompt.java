 ...
 *
 * You should have received a copy of the GNU Gener  Public License
...
public class OperPrompt extends JPanel implements PosGui {
    ...
    public void update(PosEvent event) {
    	if (event instanceof EnterPricePlu)
    		update ((EnterPricePlu)event);
    }
    ...
    public void update(Function function) {
        ...
        if (prompt != null) {
            prompt.setText(Format.print(function.promptText(),
                    Format.toMoney(Double.toString(function.num()), Application.locale()),
                    " ",
                    prompt.getWidth()));
        }
        if (operDisplay != null) {
            operDisplay.setText(Format.print(function.promptText(),
                    Format.toMoney(Double.toString(function.num()), Application.locale()),
                    " ",
                    operDisplay.getWidth()));
        }
        if (custDisplay != null) {
            custDisplay.setText(Format.print(function.promptText(),
                    Format.toMoney(Double.toString(function.num()), Application.locale()),
                    " ",
                    custDisplay.getWidth()));
        }
    }
	...
	public void update(NumKey event) {
        ...
        if (prompt != null) {
            prompt.setText(Format.print(event.promptText(),
                    event.numText(),
                    " ",
                    prompt.getWidth()));
        }
        ...
        if (operDisplay != null) {
            operDisplay.setText(Format.print(event.promptText(),
                    event.numText(),
                    " ",
                    operDisplay.getWidth()));
        }
    ...
    public void update(MultKey event) {
        ...
        if (custDisplay != null) {
            custDisplay.setText(Format.print(event.promptText(),
                    event.numText(),
                    " ",
                    custDisplay.getWidth()));
        }
    ...
    public void update(EjCheckTender tender) {
        ...
        switch (tender.state()) {
            ...
            case EjCheckTender.TENDER_FINAL:
                prompt.setText(Format.print(tender.desc(),
                        Format.toMoney(Double.toString(tender.extAmount()), tender.context().locale()),
                        " ",
                        prompt.getWidth()));
                break;
            default:
    ...
    public void update(EjItem item) {
        ...
        if (prompt != null) {
            prompt.setText(Format.print(item.desc(),
                    Format.toMoney(Double.toString(item.extAmount()), item.context().locale()),
                    " ",
                    prompt.getWidth()));
        }

        if (operDisplay != null) {
            operDisplay.setText(Format.print(item.desc(),
                    Format.toMoney(Double.toString(item.extAmount()), item.context().locale()),
                    " ",
                    operDisplay.getWidth()));
        }
        ...
        if (custDisplay != null) {
            custDisplay.setText(Format.print(item.desc(),
                    Format.toMoney(Double.toString(item.extAmount()), item.context().locale()),
                    " ",
                    custDisplay.getWidth()));
        }
    ...
    public void update(EjTender total) {
        ...
        prompt.setText(Format.print(total.desc(),
                Format.toMoney(Double.toString(total.extAmount()), total.context().locale()),
                " ",
                prompt.getWidth()));
    }
